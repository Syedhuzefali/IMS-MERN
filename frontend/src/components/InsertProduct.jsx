...
export default function InsertProduct() {
  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      ...
      const response = await fetch(buildApiUrl("/api/products/insertproduct"), {
        method: "POST",
        headers: {
        ...
        <div className="bg-white dark:bg-gray-800 rounded shadow p-6">
          ...
          <form onSubmit={handleAddProduct}>
            ...
            <div className="flex gap-4 pt-4">
              <NavLink
                to="/products"
                className="flex-1 bg-gray-500 text-white px-4 py-2 rounded text-center hover:bg-gray-600 disabled:opacity-50"
              >
                Cancel
              </NavLink>
              <button
